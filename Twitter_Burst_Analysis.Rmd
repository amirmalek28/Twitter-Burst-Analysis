...
ts_plot(twitter_data[1:50683,], "hours") +
  labs(x = NULL, y = NULL,
...
twitter_dfm <- dfm(twitter_data_ngrams, stem = F, remove_punct = F, tolower = T, remove_numbers = F,   remove = c(stopwords("english"), "http","https","rt", "t.co", ".", ",","!","?",":",";","&","-",")","/","\U0001f602","\U0001f923","(","@",'"'))
...
bursty("old_trafford", twitter_dfm, docvars(twitter_corpus)$created_at)
...
ggplot(rank_vs_burst, aes(ranking, burst_level)) + geom_point() + labs(title= "Mean Burst Level over Increasing Rankings"  ,x="Ranking", y = "Mean Burst Level")
...
ggplot(rank_vs_burst_dur, aes(ranking, max_duration)) + geom_point() + labs(title= "Mean Max Duration over Increasing Rankings"  ,x="Ranking", y = "Mean Max Duration")
...
ggplot(rank_vs_burst_mindur, aes(ranking, min_duration)) + geom_point() + labs(title= "Mean Minimum Duration over Increasing Rankings"  ,x="Ranking", y = "Mean Min Duration")


rank_vs_mentions <- all_trends_ranked %>% select(3,7) 
...
ggplot(rank_vs_mentions, aes(ranking, number_of_mentions)) + geom_point() + labs(title= "Mean Number of Mentions over Increasing Rankings"  ,x="Ranking", y = "Mean Number of Mentions")
```